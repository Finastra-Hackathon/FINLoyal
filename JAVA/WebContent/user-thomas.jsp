  ...
  <section id="user-details">
    <div class="row card indigo lighten-5">
        ...
        <div class="row">
          <div
            ...
            <img
              ...
              src="images/man-cir-1.png"
              width="200"
              height="200">
          </div>
          <div class="col s12 indigo-text">
            <h5 style="margin: 1px 1px 1px 1px; padding: 15px 1px 15px 50px;">Thomas Crane</h5>
            <div style="marging: 1px 1px 1px 1px; padding: 1px 0px 0px 25px;">
              <i class="tiny material-icons">perm_contact_calendar</i> &nbsp; 17 January 1974 (46 years)<br /> <i class="tiny material-icons">location_city</i> &nbsp; 301, Jefferson Street <br /> &nbsp; &nbsp; &nbsp; Newark, New Jersey, 07101&nbsp; <br /> <i class="tiny material-icons">local_phone</i> &nbsp; 307-299-3040<br /> <i class="tiny material-icons">email</i> &nbsp; &nbsp;thomas@example.com
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col s3">
        ...
        <div class="row indigo-text">
          <div class="col s12">
            <b>Last transaction points</b><br /> 7
          </div>
        </div>
      </div>
    </div>
