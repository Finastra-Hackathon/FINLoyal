        ...
        <div class="row">
          <div
            ...
            <img
              ...
              src="images/man-cir-2.png"
               width="200" height="200">
          </div>
          <div class="col s12 indigo-text">
            <h5 style="margin: 1px 1px 1px 1px; padding: 15px 1px 15px 50px;">Robert Boyle</h5>
            <div style="marging: 1px 1px 1px 1px; padding: 1px 0px 0px 25px;">
              <i class="tiny material-icons">perm_contact_calendar</i> &nbsp; 19 November 1978 (42 years)<br /> <i class="tiny material-icons">location_city</i> &nbsp; 301, Redford Street <br /> &nbsp; &nbsp; &nbsp; Kearny, New Jersey, 07099&nbsp; <br /> <i class="tiny material-icons">local_phone</i> &nbsp; 831-264-7261<br /> <i class="tiny material-icons">email</i> &nbsp; &nbsp;robert@example.com
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row card grey lighten-5">
      ...
      <div class="row indigo-text">
        ...
        <div class="col s3">
          ...
          <p id="current_points_range">4 - 6</p>
        </div>
        <div
          class="col s5"
