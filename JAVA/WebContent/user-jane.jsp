  ...
  <section id="user-details">
    <div class="row card indigo lighten-5">
        ...
        <div class="row">
          <div
            ...
            <img
              ...
              src="images/woman-cir-2.png"
              width="200"
              height="200">
          </div>
          <div class="col s12 indigo-text">
            <h5 style="margin: 1px 1px 1px 1px; padding: 15px 1px 15px 50px;">Jane Hoffmann</h5>
            <div style="marging: 1px 1px 1px 1px; padding: 1px 0px 0px 25px;">
              <i class="tiny material-icons">perm_contact_calendar</i> &nbsp; 22 March 1986 (34 years)<br /> <i class="tiny material-icons">location_city</i> &nbsp; 301, Washington Street <br /> &nbsp; &nbsp; &nbsp; Secaucus, New Jersey, 07096&nbsp; <br /> <i class="tiny material-icons">local_phone</i> &nbsp; 202-555-0186<br /> <i class="tiny material-icons">email</i> &nbsp; &nbsp;jane@example.com
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col s3">
        ...
        <div class="row indigo-text">
          <div class="col s12">
            <b>Last transaction points</b><br /> 3
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row card grey lighten-5">
      ...
      <div class="row indigo-text">
        ...
        <div class="col s3">
          ...
          <p id="current_points_range">3 - 5</p>
        </div>
        <div
          class="col s5"
